...
//LISTA VIDEOS
$rst_videos=mysql_query("SELECT * FROM pf_videos WHERE fecha_publicacion<='$fechaActual' AND publicar=1 ORDER BY titulo ASC", $conexion);
                ...
                <section id="main-contenido">
                    ...
                    <section id="news">
                        ...
                        <section id="nwizq" class="an100">
                            ...
                            <div class="videos" id="video" name="video">
