...
//JUGADORES
$rst_nota=mysql_query("SELECT * FROM ".$tabla_suf."_video_principal ORDER BY fecha_publicacion DESC;", $conexion);
...
<div id="content">
    <div class="contentTop">
        <span class="pageTitle"><span class="icon-screen"></span>Video principal</span>
    </div>
