...
$rst_notgaleria=mysql_query("SELECT * FROM ".$tabla_suf."_slider_oficina", $conexion);
...
if($num_notgaleria>0){
	...
	while($_POST['uploader_'.$cont.'_tmpname']<>""){
		...
		mysql_query("INSERT INTO ".$tabla_suf."_slider_oficina(imagen, imagen_carpeta, orden) VALUES ('$imagen', '$imagen_carpeta', $cont_img)",$conexion);
		$cont++; $cont_img++;
	}
	...
	while($_POST['uploader_'.$cont.'_tmpname']<>""){
		...
		$thumb{$cont}->save("../../../upload/".$imagen_carpeta."thumb/".$imagen."", "jpg");
		$imagen=$_POST['uploader_'.$cont.'_tmpname'];
		mysql_query("INSERT INTO ".$tabla_suf."_slider_oficina(imagen, imagen_carpeta, orden) VALUES ('$imagen', '$imagen_carpeta', $cont)",$conexion);
		$cont++;
	}
}
