    ...
    <div class="span2">
      ...
      <div class="sidebar-nav">
        ...
        <ul class="nav nav-list"> 
          ...
          <li class="active"><a href="forms.html"><i class="icon-th"></i> Forms</a></li>
	...
	<div class="span10">
      <div>
        <ul class="breadcrumb">
          ...
          <li>
            <a href="typography.html">Typography</a> <span class="divider">/</span>
          </li>
 	  ...
 	  <div class="row-fluid">
         ...
         <div class="span12 column" id="col0">
             ...
             <div class="box" id="box-1">
              <h4 class="box-header round-top">Datepickers, smart multiselect, autocomplete
                  <a class="box-btn" title="close"><i class="icon-remove"></i></a>
                  <a class="box-btn" title="toggle"><i class="icon-minus"></i></a>     
                  <a class="box-btn" title="config" data-toggle="modal" href="#box-config-modal"><i class="icon-cog"></i></a>
              </h4>         
              <div class="box-container-toggle">
                  <div class="box-content">
					<form class="form-horizontal">
                      <fieldset>
                        <legend>Datepicker's, autocomplete, multiselect</legend>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                          ...
                          <div class="controls">
                            <textarea class="input-xlarge html_editor_on_simple" id="textarea2" rows="3"></textarea>
                          </div>
                        </div>
                        <div class="form-actions">
                          <button type="submit" class="btn btn-primary">Save changes</button>
            ...
            <!-- Portlet: Plain form -->
             <div class="box" id="box-2">
              <h4 class="box-header round-top">Plain form
                  <a class="box-btn" title="close"><i class="icon-remove"></i></a>
                  <a class="box-btn" title="toggle"><i class="icon-minus"></i></a>     
                  <a class="box-btn" title="config" data-toggle="modal" href="#box-config-modal"><i class="icon-cog"></i></a>
              </h4>         
              <div class="box-container-toggle">
                  <div class="box-content">
                    <form class="form-horizontal">
                      <fieldset>
                        <legend>Plain version no javascript styling</legend>
                        <div class="control-group">
                          <label class="control-label" for="input01">Text input</label>
                          <div class="controls">
                            <input type="text" class="input-xlarge" id="input01">
                            <p class="help-block">Here you can add help text.</p>
                          </div>
                        </div>
                        <div class="control-group">
                          <label class="control-label" for="optionsCheckbox">Checkbox</label>
         	 ...
         	 <!-- Portlet: Multi Upload  -->
             <div class="box" id="box-3">
              <h4 class="box-header round-top">Multi Upload with Gallery
                  <a class="box-btn" title="close"><i class="icon-remove"></i></a>
                  <a class="box-btn" title="toggle"><i class="icon-minus"></i></a>     
                  <a class="box-btn" title="config" data-toggle="modal" href="#box-config-modal"><i class="icon-cog"></i></a>
              </h4>         
              <div class="box-container-toggle">
                  <div class="box-content">
                    ...
                    <form id="fileupload" action="scripts/blueimp-jQuery-File-Upload/server/php/" method="POST" enctype="multipart/form-data">
                        ...
                        <p>When uploaded click on images to see gallery</p>
                        </blockquote>
